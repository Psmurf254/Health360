...
from . import views
from .views import AppointmentListCreateView, AppointmentRetrieveUpdateDestroyView, getSpecialistById, create_specialist_feedback, create_specialist, SpecialistAppointmentListCreateView, SpecialistListView, SpecialistUpdateRetrieveUpdateDestroyView
