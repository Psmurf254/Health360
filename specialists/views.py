...
# Specialist dashboard get logged specialist
    ...
    try:
        ...
        if serializer.is_valid():
            ...
            payload = {
                ...
                "CallBackURL": f"https://6d32-154-159-252-149.ngrok-free.app/payment_webhook/?appointment_id={appointment.id}",
            ...
            stk_push_headers = {
                ...
                'Authorization': 'Bearer YDj4AR3HVGEEol9y0cxNeubtZi9Q',
            }
        ...
        try:
            ...
            if result_code == 0:
                ...
                if amount and mpesa_receipt_number and phone_number and appointment_id:
                    ...
                    payment_status = Payment.PAID_STATUS  # Assuming Payment.PAID_STATUS is the correct status

                    # Create the Payment instance with the received details and the updated payment status
